...
* 作    者 ：赵轶
* 创建时间 ：2019/5/3 23:04:59
* 更新时间 ：2019/5/3 23:04:59
* 版 本 号 ：V1.0.0.0
***********************************************************************
...
namespace BerryCore.Data.ExMessage
{
    ...
    /// 功能描述    ：数据层异常信息封装类
    /// 创 建 者    ：赵轶
    /// 创建日期    ：2019/5/3 23:04:59
    /// 最后修改者  ：赵轶
    /// 最后修改日期：2019/5/3 23:04:59
    /// </summary>
    public class DataAccessExMessage
    {
        #region 构造函数
        ...
        public DataAccessExMessage(Exception e, string userMessage = null, bool isHideStackTrace = false)
        {
