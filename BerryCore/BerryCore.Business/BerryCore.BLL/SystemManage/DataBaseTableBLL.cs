...
* 作    者 ：赵轶
* 创建时间 ：2019-12-17 18:37:37
* 更新时间 ：2019-12-17 18:37:37
* 版 本 号 ：V2.0.0.0
***********************************************************************
...
{
    /// <summary>
    /// 功能描述    ：DataBaseTableBLL  
    /// 创 建 者    ：赵轶
    /// 创建日期    ：2019-12-17 18:37:37 
    /// 最后修改者  ：赵轶
    /// 最后修改日期：2019-12-17 18:37:37 
    /// </summary>
    public class DataBaseTableBLL : IDataBaseTableBLL
    {
        private readonly IDataBaseTableService service = new DataBaseTableService();
        ...
        {
            List<DataBaseTableFieldDto> fieldList = fieldListJson.JsonToList<DataBaseTableFieldDto>();
