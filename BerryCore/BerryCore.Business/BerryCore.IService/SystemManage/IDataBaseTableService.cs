...
* 作    者 ：赵轶
* 创建时间 ：2019-12-17 17:05:18
* 更新时间 ：2019-12-17 17:05:18
* 版 本 号 ：V2.0.0.0
***********************************************************************
...
{
    /// <summary>
    /// 功能描述    ：IDataBaseTableService
    /// 创 建 者    ：赵轶
    /// 创建日期    ：2019-12-17 17:05:18
    /// 最后修改者  ：赵轶
    /// 最后修改日期：2019-12-17 17:05:18
    /// </summary>
    public interface IDataBaseTableService
    {
        ...
        void SaveForm(string dataBaseLinkId, string tableName, string tableDescription, IEnumerable<DataBaseTableFieldDto> fieldList);
