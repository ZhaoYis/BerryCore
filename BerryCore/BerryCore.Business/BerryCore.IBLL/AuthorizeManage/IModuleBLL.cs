...
* 作    者 ：赵轶
* 创建时间 ：2019-12-17 17:36:43
* 更新时间 ：2019-12-17 17:36:43
* 版 本 号 ：V2.0.0.0
***********************************************************************
...
namespace BerryCore.IBLL.AuthorizeManage
{
    ...
    /// 功能描述    ：IModuleBLL
    /// 创 建 者    ：赵轶
    /// 创建日期    ：2019-12-17 17:36:43
    /// 最后修改者  ：赵轶
    /// 最后修改日期：2019-12-17 17:36:43
    /// </summary>
    public interface IModuleBLL
    {
        ...
        /// <returns></returns>
        void SaveForm(string keyValue, ModuleEntity moduleEntity, string moduleButtonListJson, string moduleColumnListJson);
    }
}